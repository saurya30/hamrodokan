...
class UserController extends GetxController {
  ...
  void deleteAccountWarningPopup() {
    Get.defaultDialog(
      ...
      middleText: 'Are you sure you want to delete your account permanently? This action can not be reversed and all of the data will be removed permanently.',
  ...
  void deleteUserAccount() async{
    try{
      TFullScreenLoader.openLoadingDialog('Processing...', TImages.dockerAnimation);
